...
& ".\scripts\1-SetupSubscriptionForPowerPlatform.ps1" -subscriptionId $env:SUBSCRIPTION_ID
...
& ".\scripts\2-SetupVnetForSubnetDelegation.ps1" `
...
write-host "Enterprise Policy Name: ppventinjection" -ForegroundColor Green
...
& ".\scripts\3-CreateSubnetInjectionEnterprisePolicy.ps1" `
    -subscriptionId "$env:SUBSCRIPTION_ID" `
    -resourceGroup "$env:RESOURCE_GROUP" `
    -enterprisePolicyName "ppventinjection-cert-1" `
...
$policyArmId = (Get-AzResource -Name "ppventinjection-cert-1" -ResourceGroupName "$env:RESOURCE_GROUP").ResourceId
$endpoint = "prod"
...
& ".\scripts\5-NewSubnetInjection.ps1" `
...
$policy(Get-AzResource -ResourceId $policyArmId -ExpandProperties).Properties.systemId